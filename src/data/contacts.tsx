...
export const contacts: Contact[] = [
    {
        ...
        icon: <Email className="w-10 h-10 xs:w-12 xs:h-12 lg:w-20 lg:h-20 "/>
    },
    {
        id: 2,
        name: "Whatsapp",
        ...
        icon: <Whatsapp className="w-8 h-8 xs:w-10 xs:h-10 lg:w-16 lg:h-16"/>
    },
    {
        id: 3,
        name: "Instagram",
        ...
        icon: <Instagram className="w-8 h-8 xs:w-10 xs:h-10 lg:w-16 lg:h-16"/>
    },
    {
        id: 4,
        name: "Github",
        ...
        icon: <Github className="w-8 h-8 xs:w-10 xs:h-10 lg:w-16 lg:h-16"/>
    },
    {
        id: 5,
        name: "Linkedin",
        ...
        icon: <Linkedin className=" w-7 h-7 xs:w-9 xs:h-9 lg:w-14 lg:h-14 "/>
    }
]
